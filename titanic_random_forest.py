...
forest_cv = RandomForestClassifier(max_depth = max_depth, min_samples_split = min_samples_split)
forest_cv = forest_cv.fit(features_train, target_train)
predicted_train = forest_cv.predict(features_train)
predicted_cv = forest_cv.predict(features_cv)
...
# Fit random forest
my_forest = RandomForestClassifier(max_depth = max_depth, min_samples_split = min_samples_split)
my_forest = my_forest.fit(train_features, target)

# Predict using random forest:
test_dt = test
test_dt['Survived'] = my_forest.predict(test_features)
